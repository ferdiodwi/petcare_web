                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div>
                        ...
                        <div class="relative">
                            <input type="text"
                                   ...
                                   class="w-full px-4 py-3 rounded-md border-0 text-base text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-300">
                    ...
                    <div>
                        ...
                        <select wire:model.live="category"
                                class="w-full px-4 py-3 rounded-md border-0 text-base text-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-300">
            ...
            @forelse($services as $service)
                <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
                    ...
                    <div class="p-6">
                        ...
                        <button class="w-full flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                            Hubungi Kami
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="lg:text-center">
                ...
                <p class="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
                    Tim kami siap membantu Anda menemukan layanan yang tepat untuk kebutuhan Anda.
                </p>
            </div>
